...
export class AddEventComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,private calendar: NgbCalendar, public formatter: NgbDateParserFormatter) {
    ...
    this.eventForm = this.formBuilder.group({
      ...
      discription: ['', [Validators.required, Validators.minLength(5)]],
      fromDate: ['', [Validators.required, Validators.minLength(5)]],
      toDate: ['', [Validators.required, Validators.minLength(5)]],
    });
  }
