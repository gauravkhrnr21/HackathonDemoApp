...
export class AddEventComponent implements OnInit {
  ...
  interest = [{id:"sport",name:"sport"},{id:"food",name:"food"},{id:"criativity",name:"criativity"},{id:"technology",name:"technology"},{id:"stock",name:"stock"},{id:"parenting",name:"parenting"},{id:"shopping",name:"shopping"}];
