...
export class AddEventComponent implements OnInit {
  ...
  interests = [{id:"sport",name:"sport"},{id:"food",name:"food"},{id:"criativity",name:"criativity"},{id:"technology",name:"technology"},{id:"technology",name:"stock"},{id:"parenting",name:"parenting"},{id:"shopping",name:"shopping"}];
