...
export class AddEventComponent implements OnInit {
  ...
  onChange(index:number,categoryId:number,option:string,isChecked:boolean){
    this.selected = index;
    this.getInterest(option,isChecked);
    this.getSubInterest(index,categoryId,option,isChecked);
   /* switch (option) {
  ...
  getInterest(interest:string,categoryId:number,isChecked:boolean) {
  ...
  getSubInterest(index:number,subInterest: string, isChecked: boolean) {
