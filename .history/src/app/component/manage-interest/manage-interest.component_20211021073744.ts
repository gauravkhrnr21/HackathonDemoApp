...
export class ManageInterestComponent implements OnInit {
  ...
  interestData :any = [ {name:"Sachin Patil",department:"Technology",location:"Pune",interest:"sport",subinterest:"cricket",contact:"9865543333"},
                        ...
                        {name:"Salman Ali",department:"HR",location:"Pune",interest:"sport",contact:"7644233432"},
                        {name:"Rahul Tripati",department:"HR",location:"Pune",interest:"cricket",contact:"7644233432"},
                        {name:"Mangesh naik",department:"Networking",location:"Pune",interest:"",contact:"75244422344"},
                        {name:"Prakash Shinde",department:"Technology",location:"Pune",interest:"cricket",contact:"989867654"},
                        {name:"Parag Nikam",department:"Security",location:"Pune",interest:"cricket",contact:"989867654"},
                        {name:"Ashish Sharma",department:"HR",location:"Pune",interest:"cricket",contact:"989867654"},
                        {name:"Kartik Shah",department:"Technology",location:"Pune",interest:"cricket",contact:"989867654"}];
