   ...
   // console.log(formData);
    if((formData.interest != null && formData.interest != "") ||(formData.subInterest != null && formData.subInterest != "")){
      if(formData.subInterest !=""){
        this.interestData = this.interestData.filter((ele:any) => ele.interest === formData.interest.toLowerCase() && ele.subInterest === formData.subInterest.toLowerCase());
      }else{
        this.interestData = this.interestData.filter((ele:any) => ele.interest === formData.interest.toLowerCase());
      }
