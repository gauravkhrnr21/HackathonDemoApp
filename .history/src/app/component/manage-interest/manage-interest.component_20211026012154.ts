...
export class ManageInterestComponent implements OnInit {
  ...
  load(){
    this.httpClient.get<any>(environment.contextpath+"subCategory/getAllSubCategory").subscribe(resp =>{ 
    ...
    this.httpClient.post<any>(environment.contextpath+"subCategory/getAllUserSelectedCategory",param).subscribe(resp =>{ 
  ...
  onSubmit(form:FormGroup){
    ...
    if((formData.interest != null && formData.interest != "") ||(formData.subInterest != null && formData.subInterest != "")){
      this.loadInterest(formData.interest,formData.subInterest);
  ...
  loadInterest(interest:string,subInterest:string){
    let param = {
      interest:interest,
      subInterest:subInterest
    }
    this.httpClient.post<any>(environment.contextpath+"subCategory/searchInterest",param).subscribe(resp =>{ 
      console.log(resp);
      if(resp != null){  
      }
    });
  ...
  onSubmitForm(form:FormGroup) {
    ...
    if(this.userPerference != null){
      this.httpClient.put<any>(environment.contextpath+"subCategory/updateAllPrefernenceByCategory",this.userPerference).subscribe(resp =>{ 
        if(resp != null){
