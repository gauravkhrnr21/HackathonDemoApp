...
export class DashboardComponent implements AfterViewInit {
  //subtitle: string;
    ...
    constructor(private searchGroupService: SearchGroupService,private formBuilder: FormBuilder,private storageService:TokenStorageService,private httpClient:HttpClient) { 
