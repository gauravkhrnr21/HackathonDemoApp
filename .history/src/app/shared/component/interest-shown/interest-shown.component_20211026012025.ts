...
export class InterestShownComponent { 
  ...
  onSubmit(form:FormGroup) {
    ...
    if(formData!=null && this.userPerference != null){
      this.httpClient.post<any>(environment.contextpath+"subCategory/addAllSubCategoryByCategory",this.userPerference).subscribe(resp =>{ 
        if(resp != null){
          this.updateInterest();
  ...
  updateInterest(){
    ...
    this.httpClient.post<any>(environment.contextpath+"users/setUserStatus",user).subscribe(resp =>{}); 
  }
